...
from .views import about, home, privacy_policy, product_detail, product_list, terms_and_conditions, plant_care_tips, gardening_guides, create_product, edit_product
app_name = 'Shop'
